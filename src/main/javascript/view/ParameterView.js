...
SwaggerUi.Views.ParameterView = Backbone.View.extend({
	...
	render: function() {
		...
		// this.model.trueType = SwaggerUi.partials.signature.getParameterModelSignature(modelType, modelDefinitions);
		// console.log(this.model.trueType)
		// console.log('modeltipe',modelType)
