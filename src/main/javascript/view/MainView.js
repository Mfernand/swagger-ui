...
SwaggerUi.Views.MainView = Backbone.View.extend({
  ...
  render: function () {
    ...
    var resources = {};
    var counter = 0;
    if(void 0!==this.model.apisArray) {
  ...
  addResource: function(resource, auths){
    ...
    var res = new SwaggerUi.Views.ResourceDataView({
      model: resource,
      router: this.router,
      tagName: 'li',
      id: 'resource_data_' + resource.id,
      className: 'resource_data',
      auths: auths,
      swaggerOptions: this.options.swaggerOptions
    });
    $('#resourcedata', this.el).append(res.render().el);
